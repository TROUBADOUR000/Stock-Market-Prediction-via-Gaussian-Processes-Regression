...
class Plotter:
    ...
    def show_preprocessed_prices(self, start_year: int, end_year: int):
        ...
        for year in range(start_year, end_year + 1):
            ...
            plt.plot(x, y, alpha=0.95, label=year)
        ...
        fname = '{}/{}_{}_{}_normalized_prices.png'.format(self.__folder_name, self.__company_name, start_year, end_year)
    ...
    def show_gp_prediction(self, train_start: int, train_end: int, pred_year: int, pred_quarters: list = None):
        ...
        fname = '{}/{}_{}_prediction.png'.format(self.__folder_name, self.__company_name, pred_year)
        fig.savefig(fname, dpi=fig.dpi)
        plt.clf()
    ...
    def show_time_series(self, start_year: int, end_year: int, intermediate: bool = True):
        ...
        fname = '{}/{}_{}_{}_prices.png'.format(self.__folder_name, self.__company_name, start_year, end_year)
        fig.savefig(fname, dpi=fig.dpi)
        plt.clf()
