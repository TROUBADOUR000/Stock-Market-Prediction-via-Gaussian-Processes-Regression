...
class CsvHandler:
    ...
    def __init__(self, csv_name: str):
        ...
        self.df['Norm Close/Last'] = self.__add_normalized_data(self.df)
    ...
    def __load_data(self, csv_name: str):
        ...
        for i in range(len(self.df["Close/Last"])):
            self.df["Close/Last"][i] = float(self.df["Close/Last"][i][1:])
    ...
    def __add_quarters(self, df):
        ...
        for i in range(0, len(self.years)):
            ...
            quarters = quarters._append(dates, ignore_index=True)
